...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLETEDMEALS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPLETEDMEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPLETEDMEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPLETEDMEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPLETEDMEALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPLETEDMEALS actions', async () => {
      const expectedActions = [
        {
