...
class RecipesResourceIT {
    ...
    public static Recipes createEntity(EntityManager em) {
        Recipes recipes = new Recipes().recipeName(DEFAULT_RECIPE_NAME);
        return recipes;
    }
    ...
    public static Recipes createUpdatedEntity(EntityManager em) {
        Recipes recipes = new Recipes().recipeName(UPDATED_RECIPE_NAME);
        return recipes;
    }
    ...
    void createRecipes() throws Exception {
        ...
        assertThat(testRecipes.getRecipeName()).isEqualTo(DEFAULT_RECIPE_NAME);
    }
    ...
    void getAllRecipes() throws Exception {
        ...
        restRecipesMockMvc
            ...
            .andExpect(jsonPath("$.[*].recipeName").value(hasItem(DEFAULT_RECIPE_NAME)));
    }
    ...
    void getRecipes() throws Exception {
        ...
        restRecipesMockMvc
            ...
            .andExpect(jsonPath("$.recipeName").value(DEFAULT_RECIPE_NAME));
    }
    ...
    @Test
    @Transactional
    void putExistingRecipes() throws Exception {
        // Initialize the database
        recipesRepository.saveAndFlush(recipes);
        ...
        updatedRecipes.recipeName(UPDATED_RECIPE_NAME);
        ...
        Recipes testRecipes = recipesList.get(recipesList.size() - 1);
        assertThat(testRecipes.getRecipeName()).isEqualTo(UPDATED_RECIPE_NAME);
    }
    ...
    void partialUpdateRecipesWithPatch() throws Exception {
        ...
        partialUpdatedRecipes.recipeName(UPDATED_RECIPE_NAME);
